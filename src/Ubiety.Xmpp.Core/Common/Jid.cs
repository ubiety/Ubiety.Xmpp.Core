...
/// </summary>
public sealed partial class Jid : IEquatable<Jid>
{
    ...
    /// <summary>
    ///     Gets the username of the <see cref="Jid" /> in a user-friendly format.
    /// </summary>
    public string User
    {
        get => Unescape(_user);
    ...
    {
        var match = JidRegex().Match(value);
    ...
    {
        return UnescapeRegex().Replace(username, Evaluator);
